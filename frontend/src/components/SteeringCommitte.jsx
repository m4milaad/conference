...
function SteeringCommittee() {
      ...
      .then((data) => {
        ...
        const filtered = data.filter(
          (member) =>
            ...
            member.committee_type.trim().toLowerCase() === "steering committee"
        );
  ...
  return (
    <>
      ...
      {/* main section */}
      <section className="py-6 bg-gradient-to-b from-gray-50 to-white mb-4">
...
//   useEffect(() => {
//     fetch("http://localhost:5000/api/steering-committee")
//       .then((res) => res.json())
//       .then((data) => {
