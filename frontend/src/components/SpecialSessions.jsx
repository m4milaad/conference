...
function SpecialSessions() {
  return (
    ...
    >
      ...
      <section className="min-h-[80vh] flex items-center justify-center font-bold text-[#001d3d] px-6 -mt-30">
        <div className="text-center space-y-6 animate-fadeIn">
          {/* Title */}
          <h2 className="text-4xl md:text-6xl font-medium drop-shadow-lg">
            Special Sessions
          </h2>

          {/* Coming Soon */}
          <p className="border border-white rounded-xl text-lg md:text-2xl text-[#333d29] tracking-wide p-4 bg-white/60 shadow-sm font-regular">
            🚀 Special Session details to be declared soon. Stay tuned!
          </p>
